    ...
    <section className="flex flex-col max-w-[525px] justify-center ml-[9%] 2xl:ml-[15%]">
      ...
      <div className="font-NS font-normal text-[1rem] text-[#666]">
        ...
        <h3 className="pt-4 leading-normal">
          ...
          <span className="text-[#FF7700] font-semibold">Node.js and Express.js</span>, 
          ...
          <a
            className="text-[#FF7700] font-semibold underline"
        ...
        <h3 className="pt-4 leading-normal">
          ...
          <a className="text-[#FF7700] font-semibold underline" href="/CV.pdf" download>
            download
        ...
        <h3 className="pt-11 leading-normal text-[#666]">
          ...
          <span className="text-[#FF7700] font-semibold">後端開發者</span>，
          但在需要時，也能打造優雅且實用的前端。
        ...
        <h3 className="pt-4 leading-normal text-[#666]">
          他的核心技術專長包括
          <span className="text-[#FF7700] font-semibold">Node.js 和 Express.js</span>，
